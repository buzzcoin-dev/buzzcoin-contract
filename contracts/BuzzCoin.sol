...
contract BuzzCoin is ERC20, Ownable {
    ...
    uint256 public constant holderShare = 3;
    ...
    uint256 private miniumForDividend = supply / 1000; // 1%

    constructor(IRouter router_, address marketing_) ERC20("Buzz Coin", "$Buzz") {
        router = router_;
    ...
    function _initProcess(address to) private {
